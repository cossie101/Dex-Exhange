...
export default function Home() {
  ...
  // `reservedCD` keeps track of the Fuel tokens Reserve balance in the Exchange contract
  ...
  /**
   * swapTokens: Swaps  `swapAmountWei` of Eth/Fuel tokens with `tokenToBeReceivedAfterSwap` amount of Eth/Fuel tokens.
   */
  ...
  /**
   * _getAmountOfTokensReceivedFromSwap:  Returns the number of Eth/Fuel tokens that can be received
   * when the user swaps `_swapAmountWEI` amount of Eth/Fuel tokens.
   */
   ...
   * then we calculate the Fuel tokens he can add, given the Eth he wants to add by keeping the ratios
   * constant
   */
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Fuel tokens
            <br />
          ...
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of Fuel tokens"
                  onChange={(e) =>
                    setAddCDTokens(
        ...
        <div>
          ...
          <select
            ...
            onChange={async () => {
              ...
              // Initialize the values back to zer
  ...
  return (
    <div>
      <Head>
        <title>Fuel Exchange</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Fuel Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Fuel Tokens
          </div>
          <div>
            <button
